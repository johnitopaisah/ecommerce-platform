      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-2 mb-6">
            <Package size={16} className={product.in_stock ? "text-green-500" : "text-red-400"} />
            ...
            <div className="flex items-center gap-3 mt-auto">
              <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                <button onClick={() => setQty((q) => Math.max(1, q - 1))}
                  className="px-3 py-2 text-gray-600 hover:bg-gray-100 transition-colors">−</button>
              ...
              <Button size="lg" className="flex-1" onClick={handleAdd} isLoading={isLoading}
