        ...
        <div className="flex-1">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
              ...
              <Input id="full_name" label="Full name" {...register("full_name")} error={errors.full_name?.message} />
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
              ...
              <Input id="address_line_1" label="Address" {...register("address_line_1")} error={errors.address_line_1?.message} />
              <Input id="address_line_2" label="Apartment, suite, etc. (optional)" {...register("address_line_2")} />
              ...
              <Input id="country" label="Country code" placeholder="GB" maxLength={2}
        ...
        <div className="lg:w-80 shrink-0">
          <div className="bg-white border border-gray-200 rounded-xl p-6 sticky top-24">
            <h2 className="font-semibold text-gray-900 mb-4">
              Order summary ({basket.total_items} {basket.total_items === 1 ? "item" : "items"})
            </h2>
            <div className="space-y-3 mb-4">
              {basket.items.map((item) => (
                <div key={item.product_id} className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900 shrink-0">{formatPrice(item.line_total)}</span>
                </div>
              ))}
            </div>
